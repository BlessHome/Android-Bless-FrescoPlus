...
import com.bless.fresco.widget.html.getter.HtmlLocalImageGetter;
import com.bless.fresco.widget.html.getter.HtmlRemoteImageGetter;
...
public class HtmlTextView extends JellyBeanSpanFixTextView {
    ...
    boolean mLinkHit;
    protected boolean removeFromHtmlSpace = false;
    protected ClickableTableSpan mClickableTableSpan;
    protected DrawTableLinkSpan mDrawTableLinkSpan;
     ...
     */
    static protected String convertStreamToString(InputStream is) {
    ...
    protected CharSequence removeHtmlBottomPadding(CharSequence text) {
        if (text == null) {
            return null;
